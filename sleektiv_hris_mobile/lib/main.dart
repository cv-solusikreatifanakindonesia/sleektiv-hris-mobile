...
import 'sleektiv_hris_leave/all_assigned_leave.dart';
import 'sleektiv_hris_leave/leave_allocation_request.dart';
import 'sleektiv_hris_leave/leave_overview.dart';
import 'sleektiv_hris_leave/leave_request.dart';
import 'sleektiv_hris_leave/leave_types.dart';
import 'sleektiv_hris_leave/my_leave_request.dart';
import 'sleektiv_hris_leave/selected_leave_type.dart';
import 'sleektiv_hris_main/login.dart';
import 'sleektiv_hris_main/home.dart';
import 'sleektiv_hris_main/notifications_list.dart';
...
Future<void> main() async {
  ...
  AndroidInitializationSettings('@mipmap/sleektiv_hris_logo');
    ...
    return Container(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Image.asset(
              'assets/sleektiv_hris-logo.png', // Path to your logo
